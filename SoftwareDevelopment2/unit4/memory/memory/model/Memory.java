...
public class Memory {
    ...
    public void register(MemoryObserver observer){
    ...
    public void flip(int col, int row) throws MemoryException {
        ...
        if(observer != null){
            observer.cardChanged(this, col, row);
        }
    }
    ...
    private void removeCard(Move move) {
        if(move != null) {
            ...
            if(observer != null){
                try {
                    observer.cardChanged(this, row, col);
    ...
    private void placeCardFaceDown(Move move) {
        ...
        if(observer != null){
            try {
                observer.cardChanged(this, move.getRow(), move.getCol());
            } catch (MemoryException e) {
                e.printStackTrace();
            }
        }
